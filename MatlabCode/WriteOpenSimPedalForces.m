function WriteOpenSimPedalForces(OutputData)
% 
% WriteOpenSimOutputFile: Writes model states to an OpenSim STO file
%
% Input:
...
%
% Output:
%  An OpenSim states file (.mot)
%
% Authors: Brian Umberger & Leng-Feng Lee, UMass Amherst
%
% This function was inspired by ReadOpenSimData.m by Daniel Jacobs (Stanford)
% 

% Open file with write permission
fid = fopen([OutputData.name,'.mot'],'w');
...
for i = 1:OutputData.nRows
   for j = 1:OutputData.nColumns
      if j == OutputData.nColumns
         ...
         fprintf(fid,'%16.14f\t',OutputData.data(i,j));
      end
   end
end
